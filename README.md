...
- Step 1. [x] Following the instructions in the `components/Header.js` file, create the Header.

- Step 2. [x] Following the instructions in the `components/Tabs.js` file, create the Tabs.

- Step 3. [x] Following the instructions in the `components/Cards.js` file, create the Cards.
