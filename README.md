...
- Step 2. [ ] Following the instructions in the `components/Tabs.js` file, create the Tabs.

- Step 3. [ ] Following the instructions in the `components/Cards.js` file, create the Cards.
